...
import devsearch.images.ws.shared.utils.AppConstants;

@ControllerAdvice
public class ApiExceptionHandler {

    @ExceptionHandler(value = RestApiImagesException.class)
    public ResponseEntity<Object> handleRestApiException(RestApiImagesException ex, WebRequest request) {
